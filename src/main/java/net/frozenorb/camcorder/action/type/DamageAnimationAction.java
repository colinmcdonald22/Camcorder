...
@ToString
@EqualsAndHashCode
public final class DamageAnimationAction extends Action {

    private int entityId;

    public DamageAnimationAction() {}

    public DamageAnimationAction(LivingEntity entity) {
    ...
    public void play(Playback playback, Player viewer) {
        ...
        ReflectionUtils.setField(packet, "b", 1); // 1 = Take damage
