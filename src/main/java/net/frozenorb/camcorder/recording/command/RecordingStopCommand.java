...
public final class RecordingStopCommand {
    ...
    @Command(names={ "recording stop" }, permissionNode="op")
    public static void recordingStop(Player sender, @Parameter(name="recording id") String recordingId) {
        ...
        File saveTo = new File("recording-" + recording.getId() + ".camcorder");
